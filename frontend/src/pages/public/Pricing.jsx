...
function Pricing() {
  ...
  <h2 className="about-title">Flexible & Affordable Pricing</h2>

  <p className="about-text">
    Choose a pricing plan that fits your pharmacy or medical store needs.
    Our software offers powerful features, reliable performance, and easy
    scalability at a cost-effective price, helping you manage your business
