    ...
    margin-top: 15px;
      ...
      <div className="right-section">
        <div className="login-container">
          <h2>DRUG LICENSE DETAILS</h2>
          <p className="login-subtitle">
            A pharmacy cannot operate legally without this.
          </p>
            ...
            <div className="row">
              ...
              <div className="col-md-6 mb-3">
                ...
                <input
                  ...
                  placeholder="Drug Control Department"
                  required
                />
              </div>
              ...
              <div className="col-md-6 mb-3">
                <label className="form-label">Retail License Number </label>
                <input
                  type="text"
                  className="form-control"
              ...
              <div className="col-md-6 mb-3">
                <label className="form-label">Wholesale License Number</label>
                <input
                  type="text"
                  className="form-control"
                  placeholder="Enter Wholesale License Number (If Applicable)"
                />
              </div>

              {/* Issuing State & Office */}
              <div className="col-md-6 mb-3">
                <label className="form-label">Issuing State & Office</label>
                <input
                  type="text"
                  className="form-control"
                  placeholder="Eg: West Bengal - Kolkata Office"
                  required
                />
              </div>
