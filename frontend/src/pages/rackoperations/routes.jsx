...
export default [
  {
    ...
    children: [
      // 🗄️ RACK OPERATIONS PAGES
      {
        path: ROUTES.RACK_DASHBOARD,
        element: <RackDashboard />,
      },
      {
        path: ROUTES.RACK_LIST,
        element: <RackList />,
      },
      {
        path: ROUTES.RACK_FORM,
        element: <RackForm />,
      },
      {
        path: ROUTES.SHELF_MANAGEMENT,
        element: <ShelfManagement />,
      },
      {
        path: ROUTES.RACK_LAYOUT,
        element: <RackLayout />,
      },
      {
      ...
      {
        path: ROUTES.RACK_INVENTORY,
        element: <RackInventory />,
      },
      {
        path: ROUTES.RACK_EXPIRY_ALERTS,
        element: <RackExpiryAlerts />,
      },
      {
        path: ROUTES.RACK_BARCODE_GENERATOR,
        element: <RackBarcodeGenerator />,
      },
      {
        path: ROUTES.RACK_MOVEMENT_HISTORY,
        element: <RackMovementHistory />,
      },
    ],
  },
];